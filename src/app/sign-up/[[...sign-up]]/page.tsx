    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white flex-col justify-between p-12">
        ...
        <div className="max-w-md">
          <blockquote className="text-2xl font-light leading-relaxed text-slate-300">
            &ldquo;I landed my first three clients using proposals from PitchStudio. It&apos;s like having a professional writer on staff.&rdquo;
          </blockquote>
          <div className="mt-6 flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-slate-700 flex items-center justify-center text-lg font-bold text-white">JM</div>
            <div>
              <div className="font-semibold">Jamie Martinez</div>
              <div className="text-sm text-slate-500">UX Consultant</div>
            </div>
          </div>
        </div>
        <div className="text-sm text-slate-600">
          Free 14-day trial &bull; No credit card required
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-slate-500 mb-8">Start creating winning proposals in minutes.</p>
          <SignUp
            appearance={{
              elements: {
